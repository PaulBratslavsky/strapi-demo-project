...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    embedding: Attribute.Relation<'api::article.article', 'morphOne'>;
  };
}
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    embedding: Attribute.Relation<'api::category.category', 'morphOne'>;
  };
}
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    embedding: Attribute.Relation<'api::global.global', 'morphOne'>;
...
export interface ApiNoteNote extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedBy: Attribute.Relation<'api::note.note', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    embedding: Attribute.Relation<'api::note.note', 'morphOne'>;
  };
}
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedBy: Attribute.Relation<'api::page.page', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    embedding: Attribute.Relation<'api::page.page', 'morphOne'>;
    localizations: Attribute.Relation<
      'api::page.page',
      'oneToMany',
      'api::page.page'
...
export interface ApiSettingSetting extends Schema.CollectionType {
  ...
  attributes: {
    embedding: Attribute.Relation<'api::setting.setting', 'morphOne'>;
    name: Attribute.String;
    description: Attribute.Text;
    ...
    navigation: Attribute.Component<'layout.navbar'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSiteSite extends Schema.CollectionType {
  ...
  attributes: {
    ...
    embedding: Attribute.Relation<'api::site.site', 'morphOne'>;
    articles: Attribute.Relation<
      'api::site.site',
      'oneToMany',
      'api::article.article'
